    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="flex flex-col items-center ">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item) => (
                <div className=" overflow-hidden rounded-lg max-w-[5rem] aspect-square lg:w-[5rem] lg:h-[5rem] max-h-[5rem] mt-4">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">561231 Ratings</p>
              ...
              <form className="mt-10">
                ...
                <Button className =" "varient="contained" sx={{px:"2rem", py:"1rem", bgcolor:"#9155fd",color:"white",  '&:hover': {bgcolor:"blue"}}}>
        ...
        {/* rating and reviews */}
                      ...
                      <div className="border p-5">
                        ...
                        {[1,1,1].map((item)=><ProductReviewCard/>)}
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <p className="opacity-60">56566 Ratings</p>
                          </div>
          ...
          <h1 className="py-5 text-xl text-bold"> Similer Product</h1>
